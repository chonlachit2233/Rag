...
documents = [
    ...
    "วัดพระธาตุแช่แห้ง ตำบลทุ่งช้าง, ที่อยู่: 123 หมู่ 4 ตำบลทุ่งช้าง อำเภอทุ่งช้าง จังหวัดน่าน https://maps.app.goo.gl/tVYpbdar8nveRQ6T6",
    ...
    "วัดศรีเกิด ตำบลไชยสถาน, ที่อยู่: ตำบลไชยสถาน อำเภอเชียงกลาง จังหวัดน่าน https://maps.app.goo.gl/g18Jm5aqH41EU6AW9",
    ...
    "วัดสมุน ตำบลดู่ใต้, ที่อยู่: ตำบลดู่ใต้ อำเภอปัว จังหวัดน่าน https://maps.app.goo.gl/ijn9Us11s25EuLhF6",
    ...
    "วัดถืมตอง ตำบลถืมตอง, ที่อยู่: ตำบลถืมตอง อำเภอท่าวังผา จังหวัดน่านhttps://maps.app.goo.gl/t6hHq84LNV4NphdC6",
    ...
    "วัดเชียงแข็ง ตำบลในเวียง, ที่อยู่: ตำบลในเวียง อำเภอเมือง จังหวัดน่าน https://maps.app.goo.gl/NZUWeF8CJsvDm2zx9",
    "วัดดอนแก้ว ตำบลในเวียง, ที่อยู่: ตำบลในเวียง อำเภอเมือง จังหวัดน่าน https://maps.app.goo.gl/knFsHZJB9AsYvBSM7",
...
query = st.text_input("กรุณาป้อนชื่อวัดหรืออำเภอที่ต้องการค้นหา:")
if st.button("ค้นหา"):
    if query:
